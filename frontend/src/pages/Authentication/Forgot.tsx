...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(err);
      toast.error('Error: There is no user with Email address'); // Log the entire error object for inspection
      toast.error(typeof err); // Log the entire error object for inspection
    } finally {
      ...
      <div className='flex flex-wrap items-center fixed inset-0'>
        ...
        <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
          <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
            <span className='mb-1.5 block font-medium'>Don't Worry</span>
