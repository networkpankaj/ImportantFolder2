        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/user/leaves' || pathname.includes('leaves')
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/user/profile' || pathname.includes('profile')
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                          <li>
                            <NavLink
                              to='/user/profile/personalDetails'
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }>
                    ...
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                          ...
                          <li>
                            <NavLink
                              to='/user/attendance/punchInDetails'
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }>
