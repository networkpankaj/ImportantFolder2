        ...
        <nav className='mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/setup' || pathname.includes('setup')
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6'>
                          ...
                          {/* <!-- Menu Item Shift timing --> */}

                          <li>
                            <NavLink
                              to='/setup/shiftTiming'
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }>
                          ...
                          {(handleClick, open) => {
                            return (
                              <React.Fragment>
                                <NavLink
                                  to='#'
                                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-12 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                ...
                                <div
                                  ...
                                  <ul className='mt-4 mb-5.5 flex flex-col gap-2.5 pl-6 '>
                                    ...
                                    <li>
                                      <NavLink
                                        to='/attendence/report/punchReport'
                                        className={({ isActive }) =>
                                          'group relative flex items-center gap-2.5 rounded-md px-12 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                          (isActive && '!text-white')
                                        }>
                                        Punch Report
                                      </NavLink>
                                    ...
                                    <li>
                                      <NavLink
                                        to='/attendence/report/forgotPunch'
                                        className={({ isActive }) =>
                                          'group relative flex items-center gap-2.5 rounded-md px-12 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                          (isActive && '!text-white')
                                        }>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/leaves' || pathname.includes('leaves')
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
